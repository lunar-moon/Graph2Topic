...
class Graph2Topic:
    ...
    def __init__(self, top_n_words=10, nr_topics=10, embedding_model=None, embedding=None,dim_size=-1, word_select_method=None,graph_method=None,seed=42,data_name=None):
